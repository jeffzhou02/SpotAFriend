...
import { StyleSheet, Platform, TextInput, TouchableOpacity, Image, ImageBackground } from "react-native";
    ...
    return (
        <View>
            ...
            <View style={styles.ButtonContainer}>
                <SignupButton {...navigation} username={username} email={email} password={password} confirmpassword={confirmpassword}/>
